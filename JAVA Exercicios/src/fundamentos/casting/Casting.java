...
public class Casting {
    public static void main(String[] args) {
        // Exemplo De int para double (implícito)
        int valorInteiro = 3;
        ...
        float n3 = 3.30f;
        int n4;
        n4 = (int)n3; //Um casting explícito, o java entende que nós aceitamos perder as casas decimais
        ...
        int n5 = Integer.parseInt(numeroString);
